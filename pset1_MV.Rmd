...
```{r}
soil<- read.csv("https://inst-fs-iad-prod.inscloudgate.net/files/90d7237e-3130-42e6-b07d-a3b96a1da92f/Q1_soil_moisture.csv?download=1&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9._.V2nMdNbgWKIm6utMrI3sHv5Q00jIrGpD0ZewgJyKFoEiEcnY7_KRT0LuOADEM0LPyDQU5UUzhQ2_UBOOhbmeRQ")
```
...
```{r}
ggplot(data = all_data, aes(x = dates, y = lwe_thickness, group = type, color = type)) + geom_line()
